...
class PokemonBox:
    def __init__(
        ...
        if any(len(i) > 1 for i in pinyin_names):
            print(f"!!!发现多音字 {pokemon.chinese_name}, {pinyin_names=}")
        # 假设没有多音字
...
if __name__ == "__main__":
    ...
    draw_pdf(iter(pokemons), "output_a4.pdf", font_path=ttf_path)
